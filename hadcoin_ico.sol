...
contract hadcoin_ico {
    ...
    // introducing the max num of hadcoins for sale.
    uint public max_hadcoins = 100000000;
    
    // Introducing the USD to Hadcoins conversion rate
    uint public usd_to_hadcoins = 1000;
    
    // Introducing the total num of hadcoins that have been bought by the investors
    ...
    modifier can_buy_hadcoins(uint usd_invested) {
        ...
        _; // _; = relates to the require statement's function will only be applied if the condition is true?
    }
